...
router.get('/migrate', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          return _Primitive["default"].find({});
        case 2:
          prims = _context7.sent;
          pm = prims.reduce(function (o, d) {
            o[d.plainId] = d._id.toHexString();
            return o;
          }, {});
          remap = function remap(node) {
            if (node instanceof Array) {
              ...
              return Object.keys(node).reduce(function (o, k) {
                o[k] = remap(node[k]);
                return o;
              }, {});
            }
          ...
          prims.forEach(function (p) {
            if (p.primitives) {
              console.log(" Starting --- ".concat(p.plainId));
              console.log(p.primitives);
              var remapped = remap(p.primitives);
